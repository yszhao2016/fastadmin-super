...
class FlowCrud extends Command
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        if ($delete) {
            $readyFiles = [$controllerFile, $modelFile, $validateFile, $addFile, $editFile, $langFile, $javascriptFile];
...
EOD;
    ...
    {
        return __DIR__ . DS . 'FlowCrud' . DS . 'stubs' . DS . $name . '.stub';
    }
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8 {$typestring}">
            {$content}
        </div>
    </div>
    {/if}
