define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fastflow/bill/flow_job/index' + location.search,
                    add_url: 'fastflow/bill/flow_job/add',
                    edit_url: 'fastflow/bill/flow_job/edit',
                    del_url: 'fastflow/bill/flow_job/del',
                    multi_url: 'fastflow/bill/flow_job/multi',
                    import_url: 'fastflow/bill/flow_job/import',
                    table: 'flow_job',
                }
            });
